...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public string ToXMLString()
        {
            ...
            //Create the "Stats" child node to hold the other palyer stats nodes
            ...
            //Create player quest node for each quest the player has acquired
            ...
            return playerData.InnerXml; // XML documetn as a string so it can be saved
        }
    }
}