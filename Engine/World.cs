...
namespace Engine
{
    public static class World
    {
        ...
        public const int ITEM_ID_SPIDER_SLIK = 9;
        ...
        public const int LOCATION_ID_TOW_SQUARE = 2;
        ...
        private static void PopulateMonsters()
        {
            ...
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_SNAKESKIN), 72, true));
            ...
            giantSpider.LootTable.Add(new LootItem(
                ItemByID(ITEM_ID_SPIDER_SLIK), 25, false));
        ...
        private static void PopulateQuests()
        {
            Quest clearAlchemistGarden = new Quest(QUEST_ID_CLEAR_ALCHEMIST_GARDEN,
                ...
                "Kill rats in teh alchemist's garden and bring back 3 rat tails."
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMIST_GARDEN, "Alchemist's garden",
                "Many palnts are growing here.");
